...
export const siteName = 'Common.Guide';
export const version = '0.1';
export const siteDescription =
  ' Common.Guide is a collaborative repository of "decent" policy, governance practice and ideas for radical community organisation';
export const siteType = 'Person'; // schema
export const locale = 'en_EN';
export const lang = 'en';
export const skipContent = 'Skip to content';
export const author = {
  name: 'Common.Guide', // i.e. Lene Saile - page / blog author's name. Must be set.
...
export const blog = {
  // RSS feed
  name: 'Common.Guide Blog',
  description: 'Updates from time to time.',
